...
(function () {
  ...
  // Never gate content embedded in an iframe -- same rule landing-guard.js
  // already follows, for the same reason: the parent page is already gated,
  // and an iframe has no sensible place to show a lock screen.
